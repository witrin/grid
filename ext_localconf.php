...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['contentContainer'] = array_merge(
    ...
    [
        \TYPO3\CMS\Grid\Form\Data\Record\LanguageUidProvider::class => [
            'depends' => [
                \TYPO3\CMS\Backend\Form\FormDataProvider\TcaInline::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsConfigProvider::class => [
            'depends' => [
                \TYPO3\CMS\Backend\Form\FormDataProvider\TcaInline::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsTcaProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsConfigProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsDefaultValuesProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsConfigProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsProvider::class => [
            'depends' => [
                \TYPO3\CMS\Backend\Form\FormDataProvider\TcaInline::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsConfigProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateDimensionsProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\PageLayout\TemplateProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateAreasCollisionsProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateDimensionsProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateAreasSortingProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\TemplateAreasOverlaysProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateAreasAccessProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateAreasItemsProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateProvider::class,
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsProvider::class,
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsTcaProvider::class
        ...
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\TemplateAreasInsertActionProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\LayoutContainer\TemplateAreasOverlaysProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\TemplateAreasLocalizeActionProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\LayoutContainer\TemplateAreasOverlaysProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\ItemPresetsProvider::class => [
            'depends' => [
                \TYPO3\CMS\Backend\Form\FormDataProvider\TcaInline::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\LocalizationStrategyProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\ItemsProvider::class
            ]
        ],
        \TYPO3\CMS\Grid\Form\Data\LayoutContainer\LocalizationStatusProvider::class => [
            'depends' => [
                \TYPO3\CMS\Grid\Form\Data\GridContainer\TemplateAreasItemsProvider::class
            ]
        ]
...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['contentElement'] = array_merge(
    [
        ...
        \TYPO3\CMS\Grid\Form\Data\ContentElement\PrependActionProvider::class => [],
        \TYPO3\CMS\Grid\Form\Data\ContentElement\ToggleActionProvider::class => [],
        \TYPO3\CMS\Grid\Form\Data\ContentElement\VisibilityProvider::class => [],
        \TYPO3\CMS\Grid\Form\Data\Record\LanguageUidProvider::class => [],
    ]
);
...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['pageContent'] = array_merge(
    ...
    [
        \TYPO3\CMS\Grid\Form\Data\PageContent\AppendActionProvider::class => [],
        \TYPO3\CMS\Grid\Form\Data\PageContent\PreviewTemplateProvider::class => []
    ]
);
