...
namespace TYPO3\CMS\Wireframe\Form\Data;
...
/**
 * A data provider group for grid container records
 */
class GridContainerGroup implements FormDataGroupInterface
{
    /**
     * Compile form data
     *
    ...
    public function compile(array $result)
    {
        ...
        $orderedProviderList->setProviderList(
            $result['customData']['tx_grid']['containerProviderList']
                ?? (array)$GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['gridContainer']
        );
